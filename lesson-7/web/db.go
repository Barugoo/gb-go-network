...
type DB interface {
	GetLists() ([]TaskList, error)
	GetList(id string) (TaskList, error)
	CreateList(list TaskList) (TaskList, error)
	UpdateList(list TaskList) (TaskList, error)
}
...
func (db *dbMongo) GetLists() ([]TaskList, error) {
	var res []TaskList

	collection := db.client.Database(dbName).Collection("lists")
...
func (db *dbMongo) GetList(id string) (TaskList, error) {
	collection := db.client.Database(dbName).Collection("lists")
...
func (db *dbMongo) CreateList(list TaskList) (TaskList, error) {
...
func (db *dbMongo) UpdateList(list TaskList) (TaskList, error) {
	c := db.client.Database(dbName).Collection("lists")
